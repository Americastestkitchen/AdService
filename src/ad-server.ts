...
class AdServer {
    ...
    setServicerConfig(){
      ...
      if(!isEmpty(this.matchers)) this.adServicer.setMatchers(this.matchers);
      if(!isEmpty(this.tags)) this.adServicer.setTags(this.tags);
      if(!isEmpty(this.thirdPartyCallbacks)) this.adServicer.setThirdPartyCallbacks(this.thirdPartyCallbacks);
    }
